    ...
    def __init__(
        ...
        **kwargs
        ...
        executors_param = " --num-executors {} ".format(
            n_nodes * kwargs.get("executors_per_node", 8)
        )
...
if __name__ == "__main__":
    ...
    benchmarks = [
        ...
        new_mt_run(PythonMTRun, 1),
        new_mt_run(PythonMTRun, 2),
        new_mt_run(PythonMTRun, 4),
        new_mt_run(PythonMTRun, 8),
        new_mt_run(PythonMTRun, 16),
        PythonVanillaRun,
        PythonNoBBRun,
        FEBenchmarkMinRun,
        FEBenchmarkRun,
